...
<body
	...
	<div id="main-content">
		<br> <label
			style="background-color: darkgray; font-size: 35px; font-family: sans-serif">C
			Programming Tutorials</label>
		...
		<div id="third">
			<h1
				style="text-align: center; font-family: sans-serif; color: white; margin-left: 5%">
				<b>C++ Videos Tutorials</b>
			</h1>
			<center>
				<iframe width="560" height="315"
					src="https://www.youtube.com/embed/videoseries?list=PLALTCe5kaIaVuW4cy1Di-olEEJV8nfD-B"
					frameborder="0" gesture="media" allow="encrypted-media"
					allowfullscreen></iframe>
				<br>
				<p>C++ Tutorial By Cave of Programming</p>
			</center>
		</div>
	</div>
	<br>
